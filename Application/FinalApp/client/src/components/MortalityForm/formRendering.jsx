      ...
      <div className="min-max-row">
        <div className="min-input">
          <input
            ...
            required
          />
          {formErrors[minKey] && <div className="error-message">{formErrors[minKey]}</div>}
        </div>
        <div className="max-input">
          <input
            ...
            required
          />
          {formErrors[maxKey] && <div className="error-message">{formErrors[maxKey]}</div>}
        </div>
      </div>
    </div>
  );
...
export const renderSingleField = (baseKey, formData, formErrors, handleChange) => {
  ...
  return (
    <div className="form-group" key={baseKey}>
      ...
      <input
        ...
        required
      />
      {formErrors[baseKey] && <div className="error-message">{formErrors[baseKey]}</div>}
    </div>
  );
};
  ...
  return Object.keys(formData)
    ...
    .map((key) => {
      ...
      if (singleFields.includes(baseKey)) {
        return renderSingleField(baseKey, formData, formErrors || {}, handleChange);
      } else {
